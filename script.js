...
const questions = [
    ...
    createQuestion("Quel est votre numéro de téléphone ?", [], "Je vais pas t'appeler t'inquiètes, juste donne", false, "nombre"),
...
function genererElementsAleatoires() {
    ...
    const elements = [
        ...
        { type: 'html', html: '<input type="color" value="#39FF14"/>' },
